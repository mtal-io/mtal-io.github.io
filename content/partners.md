...
draft = false
title = 'Partners'
description = 'MTAL operates through a network of in-country partners whose knowledge, relationships, and expertise make each project viable — from the first survey to the final distribution.'
layout = 'page'
section_label = 'Partnership Network'
+++
...
Partnership enquiries can be directed to [partners@mtal.io](mailto:partners@mtal.io). We respond to every enquiry and treat all submissions with strict confidentiality.
